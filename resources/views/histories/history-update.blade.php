...
<div class="box box-primary">
  ...
  <form action="{{action('HistoryController@update', $history->id)}}" method="post">
    {{csrf_field()}}
    ...
    <div class="box-body">
      ...
      <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
        ...
        name="title" placeholder="Titulo" value="{{$history->title}}">
        @if ($errors->has('title'))
      ...
      <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
        ...
        <select class="form-control select2" style="width: 100%;" name="category" id="category" value="{{$history->category}}">
      ...
      <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
        ...
        <textarea rows="10" class="form-control" id="description" name="description" >{{$history->description}}</textarea>
      </div>
      ...
      <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
        ...
        <div class="input-group date">
          ...
          <input type="text" class="form-control pull-right" id="datepicker" name="date" value="{{$history->date}}">
        </div>
      </div>
